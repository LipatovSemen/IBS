...
select  
    nns as newnns
    ,'ДО ЕКАТЕРИНБУРГ. Внебалансовый счет учета ключей по депозитарию ячейки № '||num_ibs as name_acc
    ,v91203 as bs_sys   
from sdm$ibs_nns
where 1=1
and substr(nns,1,5) = '91203'
and filial = '382'
and otdel = '2858299385'
) 
loop     
...
GC.INS_ACC(V_ACCNUM,v91203,'810',id_owner,null,type_acc,null,date_open,r.name_acc,V_AUTOCLEAR=>'N',NO_NNS=>false,v_otdel=>'2858299385',pfilial=>pFilialId); --открытие счетов 91203
