...
select  
    nns as newnns
    ,'ДО Нижний Новгород. Счет аренды банковской ячейки № '||num_ibs as name_acc
    ,v47422 as bs_sys   
from sdm$ibs_nns
where 1=1
...
GC.INS_DOG_USL(V_ACCNUM,'810','382','1',null,v47422,'U',V_OTDEL=>'3012703215',V_DOPEN=>sysdate,NO_NNS=>true);
