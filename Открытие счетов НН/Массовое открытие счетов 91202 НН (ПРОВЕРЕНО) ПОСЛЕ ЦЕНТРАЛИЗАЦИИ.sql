...
select  
    nns as newnns
    ,'ДО Нижний Новгород. Внебалансовый счет учета ключей по депозитарию ячейки № '||num_ibs as name_acc
    ,v91202 as bs_sys   
from sdm$ibs_nns
where 1=1
...
GC.INS_ACC(V_ACCNUM,v91202,'810',id_owner,null,type_acc,null,date_open,r.name_acc,V_AUTOCLEAR=>'N',NO_NNS=>false,v_otdel=>'3012703215',pfilial=>pFilialId); --открытие счетов 91202
