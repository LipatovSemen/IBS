...
-- Generated 06-ноя-2023 16:15:09 from GC@BANK
...
union all
select '8' as ID,'Договор аренды ИБС с особыми условиями доступа' as CAPTION from dual;
    return vCursor;
  end;
...
select uuid,user_exec,date_exec,date_start,date_end from gc.ibs$income_exec order by date_exec;
  ...
  begin
    open vCursor for
select NAME_QUAL,VALUE from GC.SDM$IBS_GLOBAL_QUALS order by 1;
    return vCursor;
  end;    
