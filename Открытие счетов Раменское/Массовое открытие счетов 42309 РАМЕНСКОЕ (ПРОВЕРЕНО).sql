...
select  
    nns as newnns
    ,'РАМЕНСКОЕ. Счет залога банковской ячейки № '||num_ibs as name_acc
    ,v42309 as bs_sys   
from sdm$ibs_nns
where 1=1
...
GC.INS_DOG_USL(V_ACCNUM,'810','382','1',null,v42309,'U',V_OTDEL=>'1247202',V_DOPEN=>sysdate,NO_NNS=>true);
