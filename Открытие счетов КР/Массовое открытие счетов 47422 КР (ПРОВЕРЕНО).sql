...
select  
    nns as newnns
    ,'КР. Счет аренды банковской ячейки № '||num_ibs as name_acc
    ,v47422 as bs_sys   
from sdm$ibs_nns
where 1=1
...
GC.INS_DOG_USL(V_ACCNUM,'810','1788509','1',null,v47422,'U',V_OTDEL=>'0',V_DOPEN=>sysdate,NO_NNS=>true);
