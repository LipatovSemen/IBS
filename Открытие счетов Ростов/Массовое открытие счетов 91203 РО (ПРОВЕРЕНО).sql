...
declare
vKey number;                --ключ
pFilialId varchar2(15) := '5004115'; --------------------------------------------------------------------------------------филиал НОМЕР
...
id_owner varchar2(10) :='5004115' ; --ИД владельца счета
...
select  
    nns as newnns
    ,'РО. Внебалансовый счет учета ключей по депозитарию ячейки № '||num_ibs as name_acc
    ,v91203 as bs_sys   
from sdm$ibs_nns
where 1=1
...
GC.SET_REKV(V_ACCNUM
           ,'810'
           ,'046015088'
           ,'30101810860150000088'
           ,'00000810100000000001'
           ,'ФИЛИАЛ "СДМ-БАНК" (ПАО) В Г. РОСТОВ-НА-ДОНУ'
           ,'ФИЛИАЛ "СДМ-БАНК" (ПАО) В Г. РОСТОВ-НА-ДОНУ'
           ,'РОСТОВ-НА-ДОНУ'
           ,V_UNB=>NULL
           ,V_SELF_MFO=>NULL
