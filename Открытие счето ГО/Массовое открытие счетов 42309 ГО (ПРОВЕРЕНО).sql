...
select  
    nns as newnns
    ,'ГО. Счет залога банковской ячейки № '||num_ibs as name_acc
...
GC.INS_DOG_USL(V_ACCNUM,'810','382','1',null,v42309,'U',V_OTDEL=>'0',V_DOPEN=>sysdate,NO_NNS=>true);
